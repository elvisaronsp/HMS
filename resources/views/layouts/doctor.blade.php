...
@section('nav')
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light shadow-sm p-3 mb-5" id="ftco-navbar">
        <div class="container">
...
{{--                Dashboard--}}
{{--            </a>--}}
{{--            <a class="navbar-brand" href="{{ url('/doctor/appointments') }}">--}}
{{--                Appointment--}}
{{--            </a>--}}
{{--        @endif--}}
