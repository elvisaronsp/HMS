...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.html"><i class="flaticon-pharmacy"></i><span></span>HMS</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                @if(Auth::guard('web')->check())
                    <li class="nav-item cta"><a href="/user/dashboard" class="nav-link" ><span>Dashboard</span></a></li>
                @elseif(Auth::guard('doctor')->check())
                    <li class="nav-item cta"><a href="/doctor/dashboard" class="nav-link" ><span>Dashboard</span></a></li>
                @else
                    <li class="nav-item cta" style="margin-right: 15px">
                        <a href="/login" class="nav-link" ><span>Log as Patient</span></a>
                    </li>
                    <li class="nav-item cta">

                        <a href="/doctor/login" class="nav-link" ><span>Log as Doctor</span></a>
                    </li>
                @endif
            </ul>
        </div>
